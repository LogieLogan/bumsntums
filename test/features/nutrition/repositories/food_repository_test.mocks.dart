...
// in bums_n_tums/test/features/nutrition/repositories/food_repository_test.dart.
...
class MockAnalyticsService extends _i1.Mock implements _i10.AnalyticsService {
  ...
  @override
  _i5.Future<void> logSignUp({required String? method}) => (super.noSuchMethod(
        Invocation.method(
          #logSignUp,
          [],
          {#method: method},
  ...
  @override
  _i5.Future<void> logLogin({required String? method}) => (super.noSuchMethod(
        Invocation.method(
          #logLogin,
          [],
          {#method: method},
  ...
  @override
  _i5.Future<void> logWorkoutStarted({
  ...
  @override
  _i5.Future<void> logWorkoutCompleted({
    required String? workoutId,
    required String? workoutName,
  ...
  @override
  _i5.Future<void> logFoodScanned({required String? barcodeValue}) =>
      (super.noSuchMethod(
        Invocation.method(
          #logFoodScanned,
          [],
