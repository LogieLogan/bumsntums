...
import '../../../features/ai/providers/openai_provider.dart';
...
class AIPlanNotifier extends StateNotifier<GenerationState> {
  ...
  AIPlanNotifier(this._planningService, this._ref) 
...
final aiPlanNotifierProvider = StateNotifierProvider<AIPlanNotifier, GenerationState>((ref) {
