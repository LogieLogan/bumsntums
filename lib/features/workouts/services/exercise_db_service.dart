...
class ExerciseDBService {
  ...
  Future<List<Exercise>> getExercisesByTargetArea(String targetArea) async {
    ...
    return _localExercises.where(
      (exercise) => exercise.targetArea.toLowerCase() == targetArea.toLowerCase()
    ).toList();
  }
  ...
  // Get mock exercises - expanded with more detailed data
  List<Exercise> _getMockExercises() {
    return [
      ...
      Exercise(
        id: 'bums-1',
        name: 'Glute Bridge',
        description: 'Lie on your back with knees bent and feet flat on the floor. Lift your hips off the ground, squeezing your glutes at the top, then lower back down.',
      ...
      Exercise(
        id: 'bums-2',
        name: 'Squats',
        description: 'Stand with feet shoulder-width apart. Bend knees and lower your body as if sitting in a chair. Keep chest up and knees over toes. Return to standing.',
        ...
        targetArea: 'bums',
        difficultyLevel: 2,
        targetMuscles: ['gluteus maximus', 'quadriceps', 'hamstrings', 'calves'],
        formTips: [
        ...
        progressionExercises: ['goblet squat', 'barbell squat', 'single-leg squat'],
      ...
      Exercise(
        id: 'bums-3',
        name: 'Lunges',
        description: 'Stand tall, then step forward with one leg and lower your body until both knees form 90-degree angles. Push back to the starting position and repeat with the other leg.',
        ...
        progressionExercises: ['walking lunges', 'reverse lunges', 'weighted lunges'],
      ...
      Exercise(
        id: 'tums-1',
        name: 'Crunches',
        description: 'Lie on your back with knees bent and feet flat on the floor. Place hands behind your head and lift your shoulders off the ground, contracting your abs. Lower back down with control.',
        ...
        progressionExercises: ['bicycle crunches', 'reverse crunches', 'weighted crunches'],
      ...
      Exercise(
        id: 'tums-2',
        name: 'Plank',
        description: 'Get into a push-up position, but with weight on your forearms. Keep your body in a straight line from head to heels, engaging your core. Hold this position.',
        ...
        progressionExercises: ['side plank', 'plank with leg lift', 'plank with shoulder tap'],
      ...
      Exercise(
        id: 'tums-3',
        name: 'Russian Twists',
        description: 'Sit on the floor with knees bent and feet lifted slightly. Lean back at a 45-degree angle and twist your torso from side to side, touching the ground beside your hips.',
        ...
        progressionExercises: ['weighted russian twists', 'russian twists with extended legs'],
      ...
      Exercise(
        id: 'full-1',
        name: 'Burpees',
        description: 'Begin in a standing position. Drop into a squat position with your hands on the ground. Kick your feet back into a plank position. Immediately return your feet to the squat position. Jump up from the squat position.',
        ...
        targetArea: 'fullBody',
        difficultyLevel: 4,
        targetMuscles: ['quadriceps', 'gluteus maximus', 'pectorals', 'shoulders', 'abdominals'],
        formTips: [
          'Keep your core engaged throughout the movement',
      ...
      Exercise(
        ...
        description: 'Start in a high plank position with hands under shoulders. Rapidly alternate driving knees toward chest, as if running in place while maintaining the plank position.',
        ...
        targetArea: 'fullBody',
        difficultyLevel: 3,
        targetMuscles: ['abdominals', 'hip flexors', 'shoulders', 'chest', 'quads'],
        formTips: [
        ...
        progressionExercises: ['cross-body mountain climbers', 'slowed-down mountain climbers with leg extension'],
        regressionExercises: ['incline mountain climbers', 'slower-paced mountain climbers'],
