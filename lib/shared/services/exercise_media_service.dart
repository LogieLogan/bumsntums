...
class ExerciseMediaService {
  ...
  static const Map<String, String> exerciseDemoImageMap = {
    // Bums/Glutes exercises
    'glute_bridge': 'https://static.wixstatic.com/media/65a23c_5d6443e494334a35aa10689c513e5266~mv2.gif',
    'squat': 'https://static.wixstatic.com/media/65a23c_7b672c1e50ed40ed8ecc98c4eac564e1~mv2.gif',
    'lunge': 'https://static.wixstatic.com/media/65a23c_067696489e8d40f8a5dd58c253dc383e~mv2.gif',
    'donkey_kick': 'https://static.wixstatic.com/media/65a23c_5616451eff724bc8a10a0bda14fd7e72~mv2.gif',
    'side_leg_lift': 'https://static.wixstatic.com/media/65a23c_ef8b2f8093bb475f80ff40d728bd5d9e~mv2.gif',
    'clamshell': 'https://thumbs.gfycat.com/QueasyGlossyAcornwoodpecker-size_restricted.gif',
    
    // Tums/Core exercises
    'crunch': 'https://static.wixstatic.com/media/65a23c_001e7022f6034517a0df41a511ecb9cc~mv2.gif',
    'plank': 'https://static.wixstatic.com/media/65a23c_b94b640d5753496e841eedb9a307dcce~mv2.gif',
    'russian_twist': 'https://static.wixstatic.com/media/65a23c_ca0f80e357994222b56fb56447257d68~mv2.gif',
    'mountain_climber': 'https://static.wixstatic.com/media/65a23c_a875417c85a9496096494f9c9a100178~mv2.gif',
    
    // Full body exercises
    'burpee': 'https://static.wixstatic.com/media/65a23c_6d306d2ce4d346f1939f8ae953415c37~mv2.gif',
    'push_up': 'https://static.wixstatic.com/media/65a23c_71fd6e34c0ba44f5a632587d011d91d1~mv2.gif',
  };
  ...
  static const Map<String, String> exercisePhotoMap = {
    ...
    'lunge': 'https://images.unsplash.com/photo-1603287681836-b174ce5074c2?w=600&auto=format&fit=crop',
    ...
    // Tums/Core exercises
    'crunch': 'https://images.unsplash.com/photo-1616803689943-5601631c7fec?w=600&auto=format&fit=crop',
    'plank': 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=600&auto=format&fit=crop',
    'russian_twist': 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?w=600&auto=format&fit=crop',
    
    // Default exercise
    'default': 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=600&auto=format&fit=crop',
  };
  ...
  static const Map<String, String> targetAreaImageMap = {
    'bums': 'https://images.unsplash.com/photo-1517344884509-a0c97ec11bcc?w=600&auto=format&fit=crop',
    'tums': 'https://images.unsplash.com/photo-1544033527-b5f37676b89f?w=600&auto=format&fit=crop',
    'legs': 'https://images.unsplash.com/photo-1508215302344-b38b9d5de040?w=600&auto=format&fit=crop',
    'arms': 'https://images.unsplash.com/photo-1581009137042-c552e485697a?w=600&auto=format&fit=crop',
    'back': 'https://images.unsplash.com/photo-1544216428-3d561a482e8e?w=600&auto=format&fit=crop',
    'chest': 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&auto=format&fit=crop',
    'shoulders': 'https://images.unsplash.com/photo-1530822847156-5df684ec5ee1?w=600&auto=format&fit=crop',
  };
  
  // Difficulty level images
  static const Map<WorkoutDifficulty, String> difficultyImageMap = {
    WorkoutDifficulty.beginner: 'https://images.unsplash.com/photo-1518459031867-a89b944bffe4?w=600&auto=format&fit=crop',
    WorkoutDifficulty.intermediate: 'https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?w=600&auto=format&fit=crop',
    WorkoutDifficulty.advanced: 'https://images.unsplash.com/photo-1526401485004-46910ecc8e51?w=600&auto=format&fit=crop',
  };
  ...
  static String getBestExerciseMedia(String exercisePath, {MediaType type = MediaType.photo}) {
  ...
  // Widget to display an exercise image with all fallbacks
